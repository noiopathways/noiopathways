...
export const PortfolioProjects = () => {
    return (
        <Container className="about" id="about">
            <h1>Projects</h1>
            <Container style={{ backgroundColor: 'linen', }}>
                <Row xs={1} sm={2}>
                    <Col className="image-container">
                        <Image src="https://picsum.photos/300/200" rounded fluid />
                    </Col>
